<template>
  <div>
    <table-com :tableData='tableData' :istrue='true'></table-com>
...
<script>
import { getnadopt} from '@/network/teacher/apply';
...
export default {
  ...
  methods: {
    pagechange(){
       getnadopt(this.newrole,this.collegename,this.classname,this.currentPage,this.pagesize).then(res=>{
